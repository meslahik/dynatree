...
package ch.usi.dslab.lel.dynastarv2.command;
...
public class Command extends Message {
    ...
    transient Set<Partition> destinationPartitions = null;
    private CmdId id;
    ...
    public String toString() {
        ...
        return id + "-" + str + "[v." + this.partitioningVersion + "]";
    }

    public String toFullString() {
        String str = super.toString();
        return this.getId() + "-" + str + "[v." + this.partitioningVersion + "]";
    }
